     ...
     <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg" id="sidebar-wrapper">
                <div class="sidebar-heading"><a href="" class="list-group-item bg-transparent"><button class="btn btn-transparent bg" style="width: 100%;"><i class="fas fa-user-circle"></i>  Edit Profile</button></a>
                </div>
                <br>
